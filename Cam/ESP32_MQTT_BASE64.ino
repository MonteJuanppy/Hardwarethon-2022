...
const char* ssid = "Rizoma";
const char* password = "1nn0v@c10n";

// ws://broker.emqx.io:8083/mqtt  (MQTT.js)
// wss://broker.emqx.io:8084/mqtt  (MQTT.js)
const char* mqtt_server = "fortuitous-actor.cloudmqtt.com";
const unsigned int mqtt_port = 1883;
#define MQTT_USER               "rkejuyun"
#define MQTT_PASSWORD           "c56JRlI0Z5Z_"
#define MQTT_PUBLISH_TOPIC    "hwthon/SAMAN/tempisque/Filadelfia/sensor/001/setPicture"
#define MQTT_SUBSCRIBE_TOPIC    "hwthon/SAMAN/tempisque/Filadelfia/sensor/001/getPicture"

#define MQTT_PUBLISH_TOPIC_LEVEL    "hwthon/SAMAN/tempisque/Filadelfia/sensor/001/setLevel"
...
void sendText_LEVEL(String text) {
    String clientId = "ESP32-";
    clientId += String(random(0xffff), HEX);
    if (client.connect(clientId.c_str(), MQTT_USER, MQTT_PASSWORD)) {
      client.publish(MQTT_PUBLISH_TOPIC_LEVEL, text.c_str());
    } else {
      Serial.print("failed, rc=");
      Serial.print(client.state());
    }
